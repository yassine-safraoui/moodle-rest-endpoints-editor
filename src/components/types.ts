...
// export const EndpointResponseSchema: z.ZodType<IEndpointResponse> = z.lazy(() =>
//     z.object({
//         description: z.string().optional(),
//         nullable: z.boolean(),
//     }).and(
...
//                 properties: z.record(EndpointResponseSchema),
//             }),
//             z.object({
//                 type: z.union(['path', 'area', 'email', 'tag', 'int', 'float', 'safedir', 'lang', 'notags', 'component', 'raw', 'localurl', 'url', 'alphanum', 'bool', 'alpha', 'stringid', 'file', 'text', 'theme', 'raw_trimmed', 'alphanumext', 'plugin'].map(s => z.literal(s))).nullable(),
//             }),
//         ]),
//     ),
// );
...
// type IEndpointResponsePrimitiveTypes = {'path', 'area', 'email', 'tag', 'int', 'float', None, 'safedir', 'lang', 'notags', 'component', 'raw', 'localurl', 'url', 'alphanum', 'bool', 'alpha', 'stringid', 'file', 'text', 'theme', 'raw_trimmed', 'alphanumext', 'plugin'}
